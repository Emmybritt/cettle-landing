...
const WaitlistComponent = () => {
	const [userType, setUserType] = useState<string | null>("Listener");
	return (
		<div className="sm:flex flex-col lg:flex-row sm:justify-between w-full pb-[3rem]">
			...
			<div className="lg:w-[50%] relative md:pr-[5rem] mt-[6rem] px-[2rem]" data-aos="fade-up">
				...
				<div className="grid md:grid-cols-2 grid-cols-1 gap-4">
					...
					<Select label="User Type" defaultValue="Listener" data={userTypes} value={userType} onChange={setUserType} />
				</div>
				<div className="mt-6">
