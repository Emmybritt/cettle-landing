				...
				<div>
					...
					<div className="flex flex-col md:flex-row justify-around">
						<div className="mt-3 md:w-[30%] lg:ml-[20rem] mx-auto">
							<h3 className="md:text-[6rem] text-[3.5rem] sm:text-[5rem] font-extrabold text-[#FFFFFF] leading-[0.5rem]">
								exclusive
							</h3>
							<h3 className="md:text-[6rem] text-[3.5rem] sm:text-[5rem] font-extrabold text-[#FFFFFF]">
								rewards
							</h3>
							<p className="">
